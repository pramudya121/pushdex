            ...
            (async () => {
              try {
                ...
                return {
                  ...
                  reserve0: formatAmount(reserves[0], token0Info?.decimals || 18),
                  reserve1: formatAmount(reserves[1], token1Info?.decimals || 18),
                  tvl: parseFloat(formatAmount(reserves[0])) + parseFloat(formatAmount(reserves[1])),
                };
              } catch (error) {
